...
public class ImageNewModule extends ReactContextBaseJavaModule implements ActivityEventListener {
    private static final int PICK_IMAGE = 1;

    private Callback pickerSuccessCallback;
    private Callback pickerCancelCallback;

    public ImageNewModule(ReactApplicationContext reactContext) {
        super(reactContext);
